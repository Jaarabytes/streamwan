        ...
        <div className="xl:flex block min-h-full my-16 px-5" id="home">
            ...
            <div className="">
                ...
                <div className="sm:text-center sm:flex sm:justify-center sm:my-16 px-5">
                    <button
                     className="block w-full text-green-900 rounded-lg border-2 border-green-900 hover:bg-slate-200 transition duration:500"
                     style={{
                        paddingBlock: "10px",
                        paddingInline: "30px"
                    }}
                    ...
                    <button 
                    className="block w-full mt-5 bg-green-900 rounded-lg text-white hover:bg-green-800 transition duration:500"
                    style={{
                        paddingBlock: "10px",
                        paddingInline: "30px"
                    }}
